...
import lognPc from "../assets/AdminLogin.png";
    ...
    return (
        <Box minH="100vh" bg={variables.primaryColor2} display="flex" justifyContent="center" alignItems="center">
            ...
            >
                ...
                <Text color="#001D3D" fontWeight="bold">Admin</Text>
                ...
                <Link color="#001D3D" fontSize="md" fontWeight="bold">Forgot Password?</Link>
                </HStack>
