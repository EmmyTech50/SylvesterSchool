import {
    Box, Text, Image, Heading, Flex, Grid, Container, Button, Card, CardBody, Stack, GridItem, SimpleGrid, CardHeader, CardFooter
    ...
    return (
      <Box>
        ...
        <Box bg={variables.primaryColor1} color="#ffff" p={8} h="70vh">
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10} justifyContent="space-between" alignItems="center">
            <Heading as="h2">Our Story</Heading>
            <Box bgColor="#ffff" borderTopRadius="20px" h="65vh" position="relative" right="-450px"></Box>
          </SimpleGrid>
        </Box>
        ...
        <Box bg={variables.primaryColor2} p={8} h="50vh">
          <Heading size="md" mb={4} display="flex" flexDirection="row" alignItems="center" justifyContent="center">
            Why Choose Us?
          </Heading>
  
          <SimpleGrid spacing={4} templateColumns="repeat(auto-fill, minmax(200px, 1fr))" display="flex" flexDirection="row" alignItems="center" justifyContent="center">
        ...
        <Box bg={variables.primaryColor2} p={8} h="40vh">
          <Flex display="flex" flexDirection="row" alignItems="center" justifyContent="space-between" py={2}>
            {['Oracle-Logo-PNG5 (1)', 'Cambridge', 'unicef', 'Vector'].map((logo, i) => (
              <Box key={i}>
                <Image src={`src/IconFolder/${logo}.svg`} />
              </Box>
            ))}
          </Flex>
        </Box>
